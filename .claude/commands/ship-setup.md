---
description: 在当前项目中安装 /ship skill 的 hooks 和 E2E 工具链
---

你需要在当前项目中安装 /ship skill 所需的 hooks 和 E2E 工具。按以下步骤执行：
...
2. 将 `/Users/apple/works/claude-skills/skills/ship/hooks/ship_verify_gate.py` 复制到 `.claude/hooks/ship_verify_gate.py`

## Step 3: 安装 E2E 工具

1. 创建 `tests/` 和 `tests/e2e_scenarios/` 目录
2. 将 `/Users/apple/works/claude-skills/skills/ship/e2e/e2e_runner.py` 复制到 `tests/e2e_runner.py`
3. 将 `/Users/apple/works/claude-skills/skills/ship/e2e/e2e_gate.py` 复制到 `tests/e2e_gate.py`
4. 将 `/Users/apple/works/claude-skills/skills/ship/e2e/scenario_template.json` 复制到 `tests/e2e_scenarios/_template.json`
