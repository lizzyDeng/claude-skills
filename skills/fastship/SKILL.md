...
- 1B 技术方案 (1.4)：须为【每条 1A P0/P1 AC】显式映射 ≥1 task + ≥1 E2E（plan 内嵌 `ac_mapping` JSON 契约）；dangling/重复 ac_id/空 task|e2e/未全覆盖 = 当场 FAIL（不等 codex）。bugfix 无 1A，只验 writing-plans 签名。
